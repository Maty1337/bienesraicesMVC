...
Aplicación web desarrollada en PHP con arquitectura MVC para la gestión
de propiedades en venta y renta.\
Permite administrar propiedades desde un panel de administración, subir
imágenes, editar y eliminar registros.
...
``` bash
git clone https://github.com/Maty1337/bienesraicesMVC.git
cd bienesraicesMVC
```
